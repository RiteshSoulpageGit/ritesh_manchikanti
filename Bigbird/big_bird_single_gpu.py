...
class Trainer:
    ...
    def show_classification_report(self):
        ...
        self.model.save_pretrained("./savedmodel_multi_gpu_ddp")
...
def main(device,total_epochs, save_every):
    ...
    trainer = Trainer(model,tokenizer, train_loader,test_loader,train_dataset,test_dataset, optimizer,scheduler, device, save_every)
